(** CS 3110 Spring 2021 Assignment - Project

    @author Kaitlin Smith (kes337), Yvette Hung (yh387), Toshi Tokuyama (tt426) *)
...
(** [hours_worked] is the number of hours our group worked for this
    milestone. *)
